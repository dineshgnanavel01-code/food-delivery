...
export default function CartItem({ entry, horizontal = false }) {
  ...
  return (
    <div className="group flex items-center gap-4 rounded-2xl border border-border bg-card p-4 transition-all duration-200 hover:shadow-md">
      <img
        src={food.image}
        alt={food.name}
        loading="lazy"
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-background hover:border-emerald/50 hover:text-emerald transition-all duration-150 active:scale-90">
